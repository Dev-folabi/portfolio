...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <div className="flex justify-center mb-8">
          <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-indigo-600 dark:border-indigo-400 shadow-lg">
            <Image src="/images/profile.png" alt="Yusuf Afolabi" fill className="object-cover" priority />
          </div>
        </div>
        ...
        <p className="mt-6 text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          I build scalable backend systems and intelligent platforms that power real-world applications — from school
          management to AI mentorship and crypto-enabled bookings.
        </p>
